...
/*
Package iorand provides a ran64.Source wrapper around an io.Reader.
...
// IoRand is a wrapper around an io.Reader that implements the rand64.Source interface.
type IoRand struct {
	r         io.Reader
...
// New returns a new ran64.Source wrapper around an io.Reader using the provided binary.ByteOrder
...
// Seed is a no-op dummy function as IoRand does not support Seeding
func (r *IoRand) Seed(seed uint64) {
	// nothing to do
}
